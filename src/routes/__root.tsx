...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Scalecheck — Catch scale issues before production" },
      {
        name: "description",
        content:
          "Audit your code for N+1 queries, missing caching, connection leaks and memory issues before they break in production.",
      },
